...
public class RoastedGrottoceratopsModel<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition meat_3 = grotto_body.addOrReplaceChild("meat_3", CubeListBuilder.create().texOffs(0, 126).addBox(-11.0F, -15.0F, -28.0F, 22.0F, 30.0F, 7.0F, new CubeDeformation(0.0F))
				.texOffs(4, 204).addBox(0.0F, -20.0F, -27.0F, 0.0F, 5.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -1.0F, 17.0F));
		...
		PartDefinition grotto_R_hind_leg_segment = grotto_right_hind_leg.addOrReplaceChild("grotto_R_hind_leg_segment", CubeListBuilder.create().texOffs(106, 217).mirror().addBox(-2.0F, 1.0F, -1.0F, 6.0F, 13.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(136, 225).mirror().addBox(-3.0F, 14.0F, -3.0F, 8.0F, 2.0F, 11.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-5.0F, 8.0F, -2.0F, 0.4363F, 0.0F, -0.4363F));
	...
	public void setupAnim(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		this.grottoceratops.yRot = Mth.DEG_TO_RAD * entity.getYRot();
	}
