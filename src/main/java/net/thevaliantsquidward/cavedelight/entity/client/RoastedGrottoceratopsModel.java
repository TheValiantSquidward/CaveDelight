...
public class RoastedGrottoceratopsModel<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition grottoceratops = partdefinition.addOrReplaceChild("grottoceratops", CubeListBuilder.create().texOffs(0, 0).addBox(-26.0F, -10.0F, -26.0F, 52.0F, 3.0F, 73.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -7.0F, 14.0F, 3.1416F, 0.0F, 0.0F));
