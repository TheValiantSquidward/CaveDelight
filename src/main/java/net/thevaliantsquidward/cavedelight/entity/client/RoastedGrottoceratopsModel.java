...
public class RoastedGrottoceratopsModel<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition grotto_left_front_leg = grotto_body.addOrReplaceChild("grotto_left_front_leg", CubeListBuilder.create().texOffs(223, 34).addBox(-3.0F, -4.0F, -4.5F, 6.0F, 25.0F, 9.0F, new CubeDeformation(0.0F))
		...
		PartDefinition grotto_right_front_leg = grotto_body.addOrReplaceChild("grotto_right_front_leg", CubeListBuilder.create().texOffs(177, 35).mirror().addBox(-3.0F, -4.0F, -4.5F, 6.0F, 25.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false)
				...
				.texOffs(236, 20).mirror().addBox(0.0F, 16.0F, -7.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(237, 9).mirror().addBox(0.0F, 19.0F, -7.5F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-14.0F, 6.0F, -17.5F, -1.3963F, 0.0F, 0.0F));
		...
		PartDefinition meat_4 = grotto_body.addOrReplaceChild("meat_4", CubeListBuilder.create().texOffs(92, 113).addBox(-11.0F, -15.0F, -29.0F, 22.0F, 30.0F, 7.0F, new CubeDeformation(0.0F))
				.texOffs(4, 204).addBox(0.0F, -20.0F, -27.0F, 0.0F, 5.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -1.0F, 25.0F));
		...
		PartDefinition grotto_left_hind_leg = grottoceratops.addOrReplaceChild("grotto_left_hind_leg", CubeListBuilder.create().texOffs(61, 211).addBox(0.0F, -6.0F, -6.0F, 9.0F, 15.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(11.0F, -19.0F, 21.0F, 1.1345F, 0.0F, 0.0F));

		PartDefinition grotto_l_hind_leg_segment = grotto_left_hind_leg.addOrReplaceChild("grotto_l_hind_leg_segment", CubeListBuilder.create().texOffs(106, 217).addBox(-2.0F, -2.0F, -1.0F, 6.0F, 13.0F, 8.0F, new CubeDeformation(0.0F))
				.texOffs(136, 225).addBox(-3.0F, 11.0F, -3.0F, 8.0F, 2.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0F, 8.0F, -2.0F, 0.3927F, 0.0F, 0.4363F));
